...
# 64 "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.14.sdk/usr/include/limits.h" 3 4
...
# 12 "../cc0/lib/cc0main.c" 2
# 1 "../cc0/include/c0runtime.h" 1
# 16 "../cc0/include/c0runtime.h"
...
int main(int argc, char **argv) {
  ...
  if (sizeof(int) != 4) {
    fprintf(__stderrp, "Error: sizeof(int) == %zd != 4\n", sizeof(int));
    exit(1);
  }
  if (~(-1) != 0 || int_max()+1 != int_min() || int_min()-1 != int_max()) {
    fprintf(__stderrp, "Error: not a two's complement machine\n");
  }
  if ((-1 >> 31) != -1) {
    fprintf(__stderrp, "Error: arithmetic right shift does not sign-extend\n");
  }
